...
TRAIN_LOSS=LAD
TRAIN_DEBUG=false
TRAIN_INITIAL_GUESS_ENABLE=false
...
$BIN $TRAIN_ACTION $TRAIN_FEATURE_SIZE $TRAIN_MAX_DEPTH $TRAIN_ITERATIONS $TRAIN_SHRINKAGE $TRAIN_FEATURE_SAMPLE_RATIO $TRAIN_DATA_SAMPLE_RATIO $TRAIN_MIN_LEAF_SIZE $TRAIN_LOSS $TRAIN_DEBUG $TRAIN_INITIAL_GUESS_ENABLE $TRAIN_TRAINING_OPTIMIZATION_LEVEL $TRAIN_DATA_PATH $TRAIN_MODEL_FILE_ID_SAVING_PATH
