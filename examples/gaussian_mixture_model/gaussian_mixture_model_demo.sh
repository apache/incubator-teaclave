...
#$BIN $INPUT_MODEL_DATA_COLUMNS $INPUT_PATH $TEST_DATA_PATH
assert_eq "`$BIN $INPUT_MODEL_DATA_COLUMNS $INPUT_PATH $TEST_DATA_PATH | head -n +6 2>&1`" "`cat $EXPECTED_RESULT`"
