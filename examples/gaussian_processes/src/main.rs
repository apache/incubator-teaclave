...
fn print_usage() {
    let msg = "
    ./gaussian_processes input_model_data_columns input_model_data_path target_model_data_path test_data_path 
    input_model format:
        f32,f32,f32,f32 ...
        f32,f32,f32,f32 ...
        ...
...
fn main() {
    ...
    .unwrap();
    let task = mesatee.create_task("gaussian_processes").unwrap();
