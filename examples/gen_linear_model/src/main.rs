...
fn print_usage() {
    let msg = "
    ./gen_linear_model input_model_data_columns input_model_data_path target_model_data_path test_data_path 
...
fn main() {
    ...
    let input_payload = GenLinearModelPayload {
    ...
    .unwrap();
    let task = mesatee.create_task("gen_linear_model").unwrap();
