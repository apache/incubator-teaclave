...
fn test_login_success() {
    ...
    let enclave_info = EnclaveInfo::load_enclave_info(&runtime_config.audit.enclave_info);
    ...
    let config = SgxTrustedTlsClientConfig::new_with_attestation_report_verifier(enclave_attr);
